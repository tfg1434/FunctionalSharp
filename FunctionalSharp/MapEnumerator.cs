...
public sealed partial class Map<K, V> : IEnumerable<(K Key, V Value)> where K : notnull {
    ...
    /// <summary>
    /// Turn the map into an enumerable of ValueTuples
    /// </summary>
    /// <returns>Iterator of pairs</returns>
    [Pure]
    ...
    public struct Enumerator : IEnumerator<(K Key, V Value)> {
        ...
        /// <summary>
        /// Current value of this Map enumerator
        /// </summary>
        /// <exception cref="InvalidOperationException">If behaviour is undefined</exception>
        ...
        /// <summary>
        /// Dispose of this enumerator. Does nothing in this case.
        /// </summary>
        public void Dispose() { }
        ...
        /// </summary>
        /// <returns>Whether there are elements left</returns>
